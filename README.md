...
### Web
- **VizSQL** (web: [vizsql.io/sqlite](https://www.vizsql.io)) — Instant SQLite browser that **automatically generates ER diagrams** via drag-and-drop. Features reverse engineering of schemas, DDL generation, and query visualization. 100% private and WASM-based.
